...
uses
  ...
  FMX.Types, FMX.Controls, FMX.Forms, FMX.Graphics, FMX.Dialogs, uProfileFrame2;

type
  TForm2Profile = class(TForm)
    SterlingStyleBook: TStyleBook;
    ProfileFrame21: TProfileFrame2;
  private
