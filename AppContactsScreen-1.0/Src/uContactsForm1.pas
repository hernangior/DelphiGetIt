...
uses
  ...
  FMX.Types, FMX.Controls, FMX.Forms, FMX.Graphics, FMX.Dialogs, uContactsFrame1;

type
  TForm1Contacts = class(TForm)
    SterlingStyleBook: TStyleBook;
    ContactsFrame11: TContactsFrame1;
  private
