...
uses
  ...
  FMX.Types, FMX.Controls, FMX.Forms, FMX.Graphics, FMX.Dialogs, uContactsFrame3;

type
  TForm3Contacts = class(TForm)
    EmeraldDarkStyleBook: TStyleBook;
    ContactsFrame31: TContactsFrame3;
  private
