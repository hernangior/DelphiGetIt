...
uses
  ...
  FMX.Types, FMX.Controls, FMX.Forms, FMX.Graphics, FMX.Dialogs, uLoginFrame3;

type
  TForm3Login = class(TForm)
    DiamondStyleBook: TStyleBook;
    LoginFrame31: TLoginFrame3;
  private
