...
uses
  ...
  FMX.Types, FMX.Controls, FMX.Forms, FMX.Graphics, FMX.Dialogs, uSettingsFrame1;

type
  TForm1Settings = class(TForm)
    JetStyleBook: TStyleBook;
    SettingsFrame11: TSettingsFrame1;
  private
